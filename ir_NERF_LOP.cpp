...
//
//                              N E R F _ L O P
//			https://wiki.lazerswarm.com/wiki/LaserOpsPro:Main_Page
//
//
//==============================================================================

#define NERF_LOP_BITS	16  // The number of bits in the command
...
#define ONE_SPACE   3000  // The length of a Bit:Space for 1's
#define ZERO_SPACE  2000  // The length of a Bit:Space for 0's
...
//
#if SEND_NERF_LOP
void  IRsend::sendNerf_LOP (unsigned long data,  int nbits)
{
...
//
#if DECODE_NERF_LOP
bool  IRrecv::decodeNerf_LOP (decode_results *results)
{
